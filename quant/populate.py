...
for i in range(1,50):
    account_number =  str(random.randint(10000000,9999999999))
    owner_cif = str(random.randint(10000000,9999999999))
...
for i in range(1,20):
    ...
    accNumber = str(random.randint(10000000,9999999999))
...
db.session.add_all([
    Transaction(amount=32, accountNumber='923242', timestamp=datetime.strptime("2017-06-02", "%Y-%m-%d")),
    Transaction(amount=254, accountNumber='923242', timestamp=datetime.strptime("2017-06-05", "%Y-%m-%d")),
    Transaction(amount=354, accountNumber='923242', timestamp=datetime.strptime("2017-06-07", "%Y-%m-%d")),
    Transaction(amount=100, accountNumber='923242', timestamp=datetime.strptime("2017-06-08", "%Y-%m-%d"))
    ])
